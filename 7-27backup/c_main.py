...
# ElevenLabsのクローン音声の設定
elevenlabs_voice_id = "FeaM2xaHKiX1yiaPxvwe"
...
async def main():
    ...
    # 最初に男性の声とクローンの声の両方を読み込む
    await google_text_to_speech("声の読み込み中です。", google_voice_params)
    await elevenlabs_text_to_speech("声の読み込み中です。", elevenlabs_voice_id)
